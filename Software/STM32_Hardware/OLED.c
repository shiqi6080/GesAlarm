...
void OLED_BMP(int i)
{ 
//   OLED_DrawBMP(40,2,87,2,Pic[i]);
//   OLED_DrawBMP(40,2,87,3,Pic[i]);
//   OLED_DrawBMP(40,2,87,4,Pic[i]);
//   OLED_DrawBMP(40,2,87,5,Pic[i]);
//   OLED_DrawBMP(40,2,87,6,Pic[i]);
   OLED_DrawBMP(40,2,87,7,Pic[i]);
}
...
void OLED_Show(int8_t p){
	switch(p){
		case(1)://显示日期时间
			...
			OLED_ShowString(4,1,"Alarm time ");
			OLED_ShowNum(4,12,Next_Alarm_Time[0],2);
			OLED_ShowChar(4,14,':');
			OLED_ShowNum(4,15,Next_Alarm_Time[1],2);
			break;
		case(2)://上
			OLED_ShowString(1,6,"Move Up");
			OLED_BMP(0);
			break;
		case(3)://下
			OLED_ShowString(1,4,"Move Down");
			OLED_BMP(1);
			break;
		case(4)://b
			OLED_ShowString(1,6,"Draw 'b'");
			OLED_BMP(2);
			break;
		case(5)://e
			OLED_ShowString(1,6,"Draw 'e'");
			OLED_BMP(3);
			break;
		case(6)://v
			OLED_ShowString(1,6,"Draw 'v'");
			OLED_BMP(4);
			break;
		case(7)://闹钟关
			OLED_ShowString(2,3,"Alarm Closed!");
			break;
